...
{{--                    <li class="nav-item"><a class="nav-link" href="#learn">Learn</a></li>--}}
                    <li class="nav-item position-relative">
                        ...
                        <div class="language-dropdown bg-white shadow rounded-3 p-3 d-none" style="justify-content: space-evenly; width: 800px;">
                            @foreach ($languages as $language)
                                <div class="dropdown-item">
                                    {{ $language->title }}
                                    <ul class="d-flex flex-column gap-3">
                                        <li class="mt-2"><a style="text-decoration: none" href="{{url("$language->id/beginner/mentors")}}">Beginner</a></li>
                                        <li><a style="text-decoration: none" href="{{url("$language->id/intermediate/mentors")}}">Intermediate</a></li>
                                        <li><a style="text-decoration: none" href="{{url("$language->id/expert/mentors")}}">Expert</a></li>
                                    </ul>
                                </div>
                            @endforeach
                        </div>
